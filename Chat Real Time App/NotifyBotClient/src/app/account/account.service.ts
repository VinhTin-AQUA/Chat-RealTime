...
export class AccountService {
  ...
  confirmEmail(confirm: ConfirmEmail) {
    return this.http.put(`${environment.appUrl}/account/confirm-email`, confirm);
  }

  resendConfirmationEmail(email: string) {
    return this.http.post(`${environment.appUrl}/account/resend-confirmation-email/${email}`,email);
  }

  sendEmailForgotPassword(email: string) {
    return this.http.post(`${environment.appUrl}/account/forgot-password/${email}`, email)
  }
  ...
  getUser(userId: string) {
    return this.http.get(`${environment.appUrl}/account/get-user/${userId}`)
  }

  updateUser(model: UpdateUser) {
    return this.http.put(`${environment.appUrl}/account/update-user`,model);
  }
